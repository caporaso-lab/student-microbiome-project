...
Test for differences in community composition between individuals
-----------------------------------------------------------------

The following bash script was used to run statistical tests on weighted and
unweighted UniFrac distance matrices (time-series-only samples) to test for
differences in community composition between individuals. adonis, ANOSIM, and
PERMDISP were run using QIIME 1.7.0-dev, master@72514df, R 2.12.0, and
vegan 2.0-7.
